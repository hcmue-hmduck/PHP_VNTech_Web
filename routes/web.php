...
| Public Pages Module
|--------------------------------------------------------------------------
| Trang nguoi dung co the truy cap khong can dang nhap.
*/
...
|--------------------------------------------------------------------------
| So sanh san pham va goi AI de tao noi dung tu van.
*/
...
/*
|--------------------------------------------------------------------------
| Product Detail & Search Module
|--------------------------------------------------------------------------
| Xem chi tiet san pham, review va goi y tim kiem.
*/
...
|--------------------------------------------------------------------------
| Endpoint nhan ket qua thanh toan tu MoMo.
*/
...
| Chatbot AI Module
|--------------------------------------------------------------------------
| Luu lich su, gui tin nhan va xoa hoi thoai chatbot.
*/
...
|--------------------------------------------------------------------------
| Dang nhap, dang ky, quen mat khau, Google login va OTP.
*/
...
| Customer Module
|--------------------------------------------------------------------------
| Cac chuc nang can dang nhap: gio hang, tai khoan, thanh toan,
| don hang, danh gia va thong bao.
*/
...
| Admin Module
|--------------------------------------------------------------------------
| Quan tri dashboard, san pham, don hang, danh muc, voucher,
| flash sale, banner, nguoi dung va review.
*/
Route::prefix('admin')->middleware(['auth', 'admin'])->group(function () {
    ...
    Route::put('/brands_categories/brand/{brand}/delete', [Brands_CategoriesAdminController::class, 'deleteBrand'])->name('admin.brandscategories.brand.delete');
    ...
    Route::put('/brands_categories/category/{category}/delete', [Brands_CategoriesAdminController::class, 'deleteCategory'])->name('admin.brandscategories.category.delete');
